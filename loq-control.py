...
# Hardware access lives in hardware.py so the desktop app and the web
# agent read the SAME code. Two implementations of these sysfs paths
# would give two subtly different views of one machine.
from hardware import (  # noqa: F401
    ...
    log_battery_history,
    nvidia_query,
    read_cpu_max_energy_uj,
    read_cpu_package_energy_uj,
    read_cpu_stat,
    read_disk_stats,
    read_fan_rpm,
    read_gpu_power_draw,
